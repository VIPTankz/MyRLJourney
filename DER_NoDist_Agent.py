...
class Agent():
    ...
    def n_step(self, state, action, reward, state_, done):
        ...
        if len(self.n_states) == self.n:
            ...
            self.memory.add(self.n_states[0], self.n_actions[0],fin_reward, \
                                         state_, done)
    ...
    def learn(self):
        ...
        self.memory.update_priorities(tree_idxs, td_error.cpu().detach().numpy())
