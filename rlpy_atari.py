...
class AtariEnv(Env):
    ...
    def reset(self):
        ...
        return np.squeeze(self.get_obs(), axis=1)
    ...
    def step(self, action):
        ...
        reward = game_score #np.sign(game_score) if self._clip_reward else game_score
        ...
        return EnvStep(np.squeeze(self.get_obs(), axis=1), reward, done, info)
