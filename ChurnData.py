...
if __name__ == "__main__":
    ...
    name = "DDQN_n10_3_bs16_discount967_997_ema005"
    runs = 5
    ...
    print("AVG action std late: " + str(action_std75 / (len(games) * runs)))

    print("AVG 0 Churn early: " + str(percent0_25 / (len(games) * runs)))
    print("AVG 0 Churn late: " + str(percent0_75 / (len(games) * runs)))
